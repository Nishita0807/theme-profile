...
const ThemeWindow = () => {
  ...
  const colors = ['black', '#d9d9d9', 'white', '#c9e7b9', '#f3df98', '#8abcf7', '#eb9385', '#f9b4ee', '#9489f2', '#fef1ba'];
    ...
    <ThemeContainer bgColor={bgColor}>
      ...
      <div className='boxes'>
        <div className='palette'>
          ...
          <div>
            <div className='color-palette gradient'>
              Linear Gradients
            </div>
            <div>
              <ColorBox>
        ...
        <div className='all-box'>
          ...
          <div className='profile-contents'>
            ...
            <h5 className='heading'><FaLocationArrow/> Denver, United State</h5>
            <div className='content-box'>
I am a viisonary Graphics and UI/UX Designer, seamlessly blending artistic
falair with technical expertise. With a degree in Graphic Design. I 
consistently deliver visually stunning and user-centric solutions, leaving an 
indelible mark on the digital landscape. A a trusted collaborator, I am dedicated to crafting
